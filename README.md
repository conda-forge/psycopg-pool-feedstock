...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/psycopg-pool-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/psycopg-pool-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add psycopg-pool
# for installing globally
pixi global install psycopg-pool
```
...
It is possible to list all of the versions of `psycopg-pool` available on your platform:
...
```
pixi search psycopg-pool --channel conda-forge
```
